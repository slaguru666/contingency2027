...
| File | What it is |
|---|---|
| [`scenarios/another-bloody-treasure-map-outline.md`](scenarios/another-bloody-treasure-map-outline.md) | Synopsis, design intent, plot truth, four-act skeleton, open questions |
...
**Reuses:** the VANITY convention rules digest built for Continuum 2026 — copy
it in as `reference/vanity-convention-rules.html`, no rewrite needed.

---
*VANITY © Tim Evans. Private convention play materials — not for sale or
distribution.*
